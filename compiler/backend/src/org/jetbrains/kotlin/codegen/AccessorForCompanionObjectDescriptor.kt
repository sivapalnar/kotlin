...
class AccessorForCompanionObjectDescriptor(val companionObjectDescriptor: ClassDescriptor) :
        SimpleFunctionDescriptorImpl(
                companionObjectDescriptor.containingDeclaration,
                null,
                Annotations.EMPTY,
                Name.identifier("access$" + companionObjectDescriptor.name.asString()),
